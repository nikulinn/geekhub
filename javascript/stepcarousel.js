...
//        alert(pindex);
	...
	stepBy:function(galleryid, steps, isauto){
        if (jQuery('#header').hasClass('stop'))
        { return;}
...
//            alert(config.galleryid);
			var $controls=$('<ul class=\'buttons\'></ul>').replaceAll($templateimg).append(imgarray.join('')).find('img').wrap('<li>') //replace template link with links and return them
